<?php
// $Id: edit_area_room.php 1319 2010-04-09 09:57:20Z cimorrison $
...
$room_admin_email = get_form_var('room_admin_email', 'array');
$area_admin_email = get_form_var('area_admin_email', 'array');
...
if (isset($change_room) && !empty($room))
{
  // validate the email addresses
    $room_admin_email = implode(',',$room_admin_email);
...
if (isset($change_area) && !empty($area))
{
  ...
  $area_admin_email = implode(',',$area_admin_email);
          ...
          switch($field['name'])
          {
            ...
            case 'room_admin_email':
              echo "<label for=\"room_admin_email\">" . get_vocab("room_admin_email") . ":</label>\n";
                echo makeCheckboxGroup('room_admin_email', $row["room_admin_email"], getEncargadosYAdministradores(), $disabled);
    ...
    <legend><?php echo get_vocab("editarea") ?></legend>
      ...
      <legend><?php echo get_vocab("general_settings")?></legend>
        ...
        <?php
                ...
                echo makeCheckboxGroup('area_admin_email', $row["area_admin_email"], getEncargadosYAdministradores(), $disable);

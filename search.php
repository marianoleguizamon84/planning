<?php
// $Id: search.php 1285 2009-12-13 19:34:50Z cimorrison $
...
$sql = "SELECT E.id AS entry_id, E.create_by, E.name, E.description, E.start_time, R.area_id, R.room_name 
        FROM $tbl_entry E, $tbl_room R, $tbl_area A
        WHERE $sql_pred
